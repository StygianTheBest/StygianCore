...
-- --------------------------------------------------------------------------------------
 ...
 -- HOLIDAY
UPDATE item_template SET sellprice=@1G, buyprice=@3G WHERE entry = 37829; 	    -- Brewfest Prize Token
 
 -- CRAFT
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 24245; 	    -- Glowcap
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 28558; 	    -- Spirit Shard 
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 29736; 	    -- Arcane Rune  
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 29735; 	    -- Holy Dust 
UPDATE item_template SET sellprice=@10G, buyprice=@10G WHERE entry = 41596; 	-- Dalaran Jewelcrafter's Token
UPDATE item_template SET sellprice=@10G, buyprice=@10G WHERE entry = 43016; 	-- Dalaran Cooking Award
...
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 24579; 	    -- Mark of Honor Hold
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 24581; 	    -- Mark of Thrallmar
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 47395; 	    -- Isle of Conquest Mark of Honor
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 42425; 	    -- Strand of the Ancients Mark of Honor
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 43589; 	    -- Wintergrasp Mark of Honor

-- DUNGEON/RAID
UPDATE item_template SET sellprice=@1G, buyprice=@1G WHERE entry = 43228; 	    -- Stone Keeper's Shard
