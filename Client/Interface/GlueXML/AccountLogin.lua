...
function AccountLogin_OnLoad(self)
	...
	AccountLoginVersion:SetPoint("TOP", AccountLoginManageAccountButton, "BOTTOM", 0, -10);
...
function AccountLogin_OnShow(self)
	...
	AccountLoginRealmName:SetPoint("TOP", AccountLoginExitButton, "BOTTOM", -AccountLoginRealmName:GetWidth()/8, -10);
