...
-- their lives for in this ravaged land we all call home. 
--
-- As of the release of this module, I have only had time to create three of these NPCs, 
-- but I have plans for many more in the future, and hope that the community can contribute. 
-- I have written the module so adding new Loremaster NPCs is done purely in the database 
-- and will chain to one another automatically if done correctly.
--
-- ################################################################################### --
*/
...
INSERT INTO `creature` VALUES (@StartGUID, @StartEntry, '1', '1', '1', '0', '1', '-383.47', '-2181.44', '157.881', '0.135076', '300', '0', '0', '12600', '0', '0', '0', '0', '0');
...
INSERT INTO `creature` VALUES (@GUID, @Entry, '0', '1', '1', '0', '1', '-6571.03', '-3465.89', '304.625', '5.50124', '300', '0', '0', '12600', '0', '0', '0', '0', '0');
...
INSERT INTO `creature_equip_template` VALUES (@Entry, '1', '45861', '1906', '0', '18019'); -- Diamond Tipped Cane, Torch
INSERT INTO `creature_template_addon` VALUES (@Entry, '0', '0', '0', '0', '0', '');
INSERT INTO `creature` VALUES (@GUID, @Entry, '1', '1', '1', '0', '1', '7452.25', '-1694.05', '195.624', '3.19806', '300', '0', '0', '12600', '0', '0', '0', '0', '0');